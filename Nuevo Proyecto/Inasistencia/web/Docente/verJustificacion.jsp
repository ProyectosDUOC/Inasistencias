...
<html>
    <head>
        ...
        <%
            ...
            String fechaA = "", glosa = "", vista="", rut = "", fechaJ = "", rutA = "", nombreA = "", carreraA = "", correoA = "", nombre = "", estado = "", semestre = "", nombreDocente = "", nombreAsig = "", nombreCod = "", motivo = "";
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col s12 m6 color-Azul-text">                    
                    ...
                    <br>
                    <a class="white-text btn  waves-effect waves-light  red" href="cursos.jsp">Volver</a>
