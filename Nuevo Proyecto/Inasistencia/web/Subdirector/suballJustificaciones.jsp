...
<html>
    <head>
        ...
        <%
            ...
            Subdirector dire = new Subdirector();
            ...
            if (user == null) {
                ...
                if (estado.equals("subdirector")) {
                    dire = (new SubdirectorDAO()).buscarDatos(rut);
                    nombre = dire.getPnombre() + " " + dire.getAppaterno();
                    arrayReportes = (new ReporteSecretariaDAO()).mostrarDatosAllSubdirector(semestreActual.getSemestre(), semestreActual.getAnio());
                            ...
                            <tbody>
                                ...
                                <% } else {
                                    for (ReporteSecretaria r : arrayReportes) {
                                        ...
                                        if (justificacion.getIdMotivo()== 3 || justificacion.getIdMotivo() == 11) {
                                ...
                                <tr>
                                    ...
                                    <td><%=motivo%></td>
                                    <td><%=(new AlumnoDAO()).buscarDatosId(inasistencia.getIdAlumno()).getRutAlumno()%></td>
